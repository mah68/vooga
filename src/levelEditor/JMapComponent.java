...
public class JMapComponent extends JLayeredPane implements MouseListener,
	...
	public void mouseClicked(MouseEvent e) {
		...
		myController.addDraggableImagetoController(tileWidth
				* (e.getX() / tileWidth), tileHeight * (e.getY() / tileHeight),
				currentTile);
		this.repaint();
	}
...
//		Tile currentTile = myView.getSelectedTile();
//		myController.addDraggableImagetoController(tileWidth * (e.getX()/tileWidth), tileHeight * (e.getY()/tileHeight), currentTile);
//		this.repaint();
	}
