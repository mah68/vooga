...
As an example, the RPGGame now contains a spring which can be moved by colliding with the object and holding 'Q'. Releasing
...
Also, a koopa shell has been added in that can be thrown right or left by colliding the user character with the appropriate
side.