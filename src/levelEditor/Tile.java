...
public class Tile extends JComponent implements ImageObserver{
	...
	public Tile(int number, String path, String name, String className) {
	...
	public boolean equals(Tile t) {
		if (t == null)
			return false;
		if (this.number == t.number && this.name.equals(t.name) && this.className == t.className && this.image == t.image) {
			return true;
		} else {
			return false;
		}
